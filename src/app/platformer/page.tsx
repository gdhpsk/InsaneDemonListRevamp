  ...
  return (
    <main>
      ...
      <Text size="5" className="header">This part of the list shows the hardest insane demon platformers on the list!</Text>
        <br></br><br></br>
        {levels.filter((e: any) => !e.removalDate).map((e: Record<any, any>) => <Grid style={{placeItems: "center"}} key={e.id}>{(e.position-1) % 5 == 0 ? <Grid style={{width: "min(100%, 1650px)"}}><AdComponent adSlot="4403955848"></AdComponent></Grid> : ""}<Level level={e} platformer={true}></Level><br></br></Grid>)}
        <br></br>
        <Flex gap="4" style={{placeItems: "center", justifyContent: "center"}}>
        <img src="/favicon.ico" height="70px"></img>
