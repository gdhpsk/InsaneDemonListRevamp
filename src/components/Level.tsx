...
import { ChevronLeftIcon, ChevronRightIcon, DotFilledIcon, DotsHorizontalIcon, DrawingPinFilledIcon, ExclamationTriangleIcon, ExternalLinkIcon, InfoCircledIcon, QuestionMarkCircledIcon, RadiobuttonIcon, SpeakerLoudIcon, StarFilledIcon, StarIcon } from '@radix-ui/react-icons'
import { Badge, Box, CalloutIcon, CalloutRoot, CalloutText, Flex, Grid, HoverCardContent, HoverCardRoot, HoverCardTrigger, IconButton, Inset, PopoverContent, PopoverRoot, PopoverTrigger, Table, TableBody, TableColumnHeaderCell, TableHeader, TableRoot, TableRow, TableRowHeaderCell, Text } from '@radix-ui/themes'
                        ...
                        {level.removalReason ? <><br></br><TableRoot size="3" m="2" style={{ width: "90%" }}>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableColumnHeaderCell style={{ fontSize: "30px", color: "#7975e5" }} align="center"><PopoverRoot>
                                        <PopoverTrigger><span>AREDL #<QuestionMarkCircledIcon style={{ scale: 1, marginLeft: "5px", marginTop: "-5px", position: "absolute" }}></QuestionMarkCircledIcon></span></PopoverTrigger>
                                        <PopoverContent style={{maxWidth: "300px"}}>
                                            ...
                                            <Text size="7" weight={'bold'}>The AREDL</Text>
                                            <br></br>
                                            <Text size="5" as="p" style={{width: "250px"}}>The AREDL (All Rated Extreme Demon List) is a list of levels that contains the hardest extreme demons in the game, both rated and unrated. If you are interested in learning more about the website, click <a href="https://aredl.net" style={{color: "skyblue"}}>here.</a></Text>
                                        </PopoverContent>
                                    </PopoverRoot></TableColumnHeaderCell>
                            ...
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableRowHeaderCell style={{ fontSize: "20px" }} align="center">{level.AREDL_POS || "NA"}</TableRowHeaderCell>
                                    <TableRowHeaderCell style={{ fontSize: "20px" }} align="center">
                                        {level.removalDate}
                                    </TableRowHeaderCell>
